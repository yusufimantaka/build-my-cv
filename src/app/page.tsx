        ...
        <main className="min-h-screen bg-[#f7f7f5] font-sans text-[#171717]">
            ...
            >
                ...
                <div className="flex items-center gap-2">
                    <Link
                        href="/app"
                        className="flex items-center gap-2 rounded-md px-3 py-1.5 text-sm text-[#171717] transition-colors hover:bg-[#efefef]"
                    >
                        Coba aplikasi
                    </Link>
                    <a
            ...
            <section className="relative isolate bg-[#f7f7f5] px-6 pb-0 pt-12 text-center sm:pt-16">
                ...
                <div className="relative mx-auto max-w-4xl">
                    <span className="inline-flex animate-fade-up items-center gap-2 rounded-full border border-[#37352F]/20 bg-white/75 px-3 py-1 text-xs font-medium tracking-[0.16em] text-[#37352F] backdrop-blur">
                    ...
                    <div className="mt-6 flex animate-fade-up flex-wrap items-center justify-center gap-3" style={{ animationDelay: "240ms" }}>
                        <Link
                            href="/app"
                            className="rounded-md bg-[#37352F] px-5 py-2.5 text-sm font-medium text-white shadow-sm transition-transform hover:bg-[#2f2b26] hover:scale-[1.03] active:scale-95"
                        >
                    ...
                    <div className="grid min-h-[300px] grid-cols-[150px_1fr_190px] bg-[#f7f7f5] sm:grid-cols-[190px_1fr_260px]">
                        <div className="border-r border-[#171717]/10 bg-white p-4">
                            ...
                            <div className="mt-6 space-y-3">
                                <div className="h-8 rounded-full bg-[#37352F]/10" />
                                <div className="h-8 rounded-full bg-[#efefef]" />
                                <div className="h-8 rounded-full bg-[#efefef]" />
                                <div className="h-8 rounded-full bg-[#efefef]" />
                            </div>
                        </div>
                        <div className="flex justify-center p-6 sm:p-10">
                            <div className="w-full max-w-[390px] bg-white p-7 shadow-md sm:p-9">
                                ...
                                <div className="mt-7 flex flex-wrap gap-2"><span className="h-5 w-16 rounded-full bg-[#2383E2]/30" /><span className="h-5 w-20 rounded-full bg-[#2383E2]/30" /><span className="h-5 w-14 rounded-full bg-[#2383E2]/30" /></div>
                            </div>
                        </div>
            ...
            <section className="border-t border-[#171717]/10 bg-white">
                <div className="mx-auto max-w-3xl animate-fade-up px-6 py-14 text-center">
                    ...
                    <div className="mt-6 flex items-center justify-center gap-3">
                        ...
                        <Link
                            href="/app"
                            className="rounded-md bg-[#37352F] px-5 py-2.5 text-sm font-medium text-white transition-transform hover:bg-[#2f2b26] hover:scale-[1.03] active:scale-95"
                        >
                            Coba aplikasi
                        </Link>
                    </div>
