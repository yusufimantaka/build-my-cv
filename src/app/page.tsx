...
export default function LandingPage() {
    ...
    return (
        <main className="min-h-screen bg-[#f7f7f5] font-sans text-[#171717]">
            ...
            >
                <Link href="/" className="text-sm font-semibold text-[#37352F] hover:underline">
                    BuildMyCV
                </Link>
                <div className="flex items-center gap-2">
                    <Link
                        href="/app"
                        className="flex items-center gap-2 rounded-none px-3 py-1.5 text-sm text-[#171717] transition-colors hover:bg-[#efefef]"
                    >
                        Coba aplikasi
                    </Link>
                    <a
            ...
            <section className="relative isolate bg-[#f7f7f5] px-6 pb-0 pt-12 text-center sm:pt-16">
                <div
                    aria-hidden="true"
                ...
                <div className="relative mx-auto max-w-4xl">
                    <span className="inline-flex animate-fade-up items-center gap-2 rounded-none border border-[#37352F]/20 bg-white/75 px-3 py-1 text-xs font-medium tracking-[0.16em] text-[#37352F] backdrop-blur">
                    ...
                    <h1 className="mx-auto mt-4 max-w-4xl animate-fade-up text-3xl font-bold leading-[0.98] tracking-[-0.06em] sm:text-5xl lg:text-6xl" style={{ animationDelay: "80ms" }}>
                        ...
                        <span className="block text-[#37352F]">kamu yang terbaik.</span>
                    </h1>
                    ...
                    <div className="mt-6 flex animate-fade-up flex-wrap items-center justify-center gap-3" style={{ animationDelay: "240ms" }}>
                        <Link
                            href="/app"
                            className="rounded-none bg-[#37352F] px-5 py-2.5 text-sm font-medium text-white shadow-sm transition-transform hover:bg-[#2f2b26] hover:scale-[1.03] active:scale-95"
                        >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-2 rounded-none border border-[#171717]/20 bg-white/80 px-5 py-2.5 text-sm font-medium backdrop-blur transition-transform hover:bg-white hover:scale-[1.03] active:scale-95"
                        >
                ...
                <div className="relative mx-auto mt-10 max-w-6xl animate-fade-up translate-y-1 overflow-hidden rounded-none-2xl border border-[#171717]/15 bg-white text-left shadow-[0_18px_60px_rgba(63,99,130,0.22)]" style={{ animationDelay: "320ms" }}>
                    <div className="flex h-10 items-center gap-1.5 border-b border-[#171717]/10 bg-white px-4">
                        ...
                        <span className="h-2.5 w-2.5 rounded-none bg-[#d9d2c3]" />
                        <span className="h-2.5 w-2.5 rounded-none bg-[#d9d2c3]" />
                        <span className="ml-3 font-mono text-[10px] tracking-wide text-[#9b9a97]">buildmycv.app / editor</span>
                    </div>
                    <div className="grid min-h-[300px] grid-cols-[150px_1fr_190px] bg-[#f7f7f5] sm:grid-cols-[190px_1fr_260px]">
                        <div className="border-r border-[#171717]/10 bg-white p-4">
                            <div className="h-2 w-20 rounded bg-[#37352F]/60" />
                            <div className="mt-6 space-y-3">
                                <div className="h-8 rounded-none bg-[#37352F]/10" />
                                <div className="h-8 rounded-none bg-[#efefef]" />
                                <div className="h-8 rounded-none bg-[#efefef]" />
                                <div className="h-8 rounded-none bg-[#efefef]" />
                            </div>
                        </div>
                        ...
                        <div className="border-l border-[#171717]/10 bg-white p-4">
                            <div className="h-2 w-20 rounded bg-[#37352F]/60" />
                            <div className="mt-5 space-y-3"><div className="h-7 rounded bg-[#efefef]" /><div className="h-7 rounded bg-[#efefef]" /><div className="h-7 rounded bg-[#efefef]" /></div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="mx-auto mt-20 max-w-5xl px-6 pb-16 sm:mt-28">
                ...
                <div className="mt-8 grid gap-6 sm:grid-cols-3">
                    {principles.map((p, idx) => (
                        <div key={p.title} className="animate-fade-up rounded-none border border-[#171717]/15 bg-white p-5 shadow-sm transition-transform hover:-translate-y-1 hover:shadow-md" style={{ animationDelay: `${idx * 90}ms` }}>
                            <iconify-icon icon={p.icon} width="24" height="24" className="text-[#37352F]" />
                            <h3 className="mt-3 font-semibold">{p.title}</h3>
                            <p className="mt-1 text-sm text-[#787774]">{p.text}</p>
                        </div>
                    ))}
                </div>
            </section>
            ...
            <section className="mx-auto max-w-4xl px-6 pb-16">
                ...
                <p className="mx-auto mt-2 max-w-xl text-center text-sm text-[#787774]">
                    ...
                    {["UI (React)", "→", "WorkspaceRepository", "→", "IndexedDB"].map((step, i) => (
                        <span
                            ...
                            className={
                                step === "→"
                                    ? "text-[#37352F]"
                                    : "rounded-none border border-[#171717]/15 bg-white px-4 py-2 font-mono text-sm shadow-sm"
                            }
                        >
                            {step}
                        </span>
                ...
                <p className="mt-4 text-center font-mono text-xs text-[#787774]">
            ...
            <section className="mx-auto max-w-5xl px-6 pb-16">
                ...
                <div className="mt-8 grid gap-6 sm:grid-cols-3">
                    {roadmap.map((r, idx) => (
                        <div key={r.title} className="animate-fade-up rounded-none border border-[#171717]/15 bg-white p-5 shadow-sm transition-transform hover:-translate-y-1 hover:shadow-md" style={{ animationDelay: `${idx * 90}ms` }}>
                            <iconify-icon icon={r.icon} width="24" height="24" className="text-[#37352F]" />
            ...
            <section className="border-t border-[#171717]/10 bg-white">
                <div className="mx-auto max-w-3xl animate-fade-up px-6 py-14 text-center">
                    <iconify-icon icon="mdi:code-tags" width="36" height="36" className="text-[#37352F]" />
                    <h2 className="mt-3 text-2xl font-semibold">Berkontribusi</h2>
                    <p className="mx-auto mt-2 max-w-lg text-sm text-[#787774]">
                    ...
                    <div className="mt-6 flex items-center justify-center gap-3">
                        ...
                        <Link
                            href="/app"
                            className="rounded-none bg-[#37352F] px-5 py-2.5 text-sm font-medium text-white transition-transform hover:bg-[#2f2b26] hover:scale-[1.03] active:scale-95"
                        >
                            Coba aplikasi
                        </Link>
                    </div>
            ...
            {/* Footer */}
            <footer className="border-t border-[#171717]/10 px-6 py-6 text-center text-xs text-[#787774]">
